...
function getBuildFilePaths() {
    return __awaiter(this, void 0, void 0, function () {
        var files, parentDirectory, dirs, _i, dirs_1, dir, currentDirectory, dirStat, curFiles, protoFilesPath, _a, curFiles_1, curFile, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    curFiles = _b.sent();
                    curFiles = curFiles.filter(function (value) { return value.endsWith('.proto'); });
                    protoFilesPath = [];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, promises_1.copyFile(fp, destPath, fs.constants.COPYFILE_FICLONE)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dest_dir = outputPath;
                    return [4 /*yield*/, util_1.promisify(child_process_1.exec)("protoc --plugin=node_modules/ts-proto/protoc-gen-ts_proto --ts_proto_opt=lowerCaseServiceMethods=true,context=false,oneof=unions,useOptionals=true,env=node,returnObservable=false,stringEnums=true,addGrpcMetadata=true,addNestjsRestParameter=true,nestJs=true --ts_proto_out=" + dest_dir + " " + src_dir)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    src_dir = inputPath + "/*.proto";
                    dest_dir = outputPath;
                    return [4 /*yield*/, util_1.promisify(child_process_1.exec)("protoc --plugin=node_modules/ts-proto/protoc-gen-ts_proto.cmd --ts_proto_opt=lowerCaseServiceMethods=true,context=false,oneof=unions,useOptionals=true,env=node,returnObservable=false,stringEnums=true,addGrpcMetadata=true,addNestjsRestParameter=true,nestJs=true --ts_proto_out=" + dest_dir + " " + src_dir)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    key = _a[_i];
                    return [4 /*yield*/, writeProtoFile(protoOutputPath, key, protoFiles[key], options.rewriteProtobufName)];
                case 3:
                    _c.sent();
                    _c.label = 4;
                case 4:
                ...
                case 6:
                    _c.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, promises_1.mkdir(path.join(tsOutputPath, 'types'), { recursive: true })];
                case 7:
                    _c.sent();
                    return [3 /*break*/, 9];
                case 8:
                ...
                case 9:
                    ...
                    if (!(options.isWindows && options.isWindows === true)) return [3 /*break*/, 11];
                    return [4 /*yield*/, generateTSFromProtoWin(protoOutputPath, '.')];
                case 10:
                    _c.sent();
                    return [3 /*break*/, 13];
                case 11: return [4 /*yield*/, generateTSFromProto(protoOutputPath, '.')];
                case 12:
                    _c.sent();
                    _c.label = 13;
                case 13:
