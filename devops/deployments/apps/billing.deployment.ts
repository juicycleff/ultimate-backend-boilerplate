...
export interface BillingAppArgs extends BaseContainerAppConfig {}
...
export class BillingApp extends pulumi.ComponentResource {
  ...
  constructor(
    ...
    super('ub:boilerplate:billing-app', name, args, opts);
          ...
          template: {
            ...
            spec: {
              containers: [
                {
                  name: 'billing-svc',
                  image: `ub-boilerplate/billing:${args.imageTag}`,
